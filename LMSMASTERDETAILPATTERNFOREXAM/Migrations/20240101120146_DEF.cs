...
namespace LMSMASTERDETAILPATTERNFOREXAM.Migrations
{
    ...
    public partial class DEF : Migration
    {
        ...
        {
            string SpInsertStudent = @"CREATE PROCEDURE dbo.SpInsertStudent
...
GO";
            ...
            string SpInsertBook = @"Create procedure dbo.SpInsertBook
...
GO";
            ...
            string SpUpdateStudent = @"create procedure dbo.SpUpdateStudent
@StudentId int,
@StudentName nvarchar(50),
@Address nvarchar(max),
@Email nvarchar(max),
...
GO";
            ...
            string SpDeleteStudent = @"Create procedure dbo.SpDeleteStudent
@StudentId int
as
DELETE FROM Books where StudentId=@StudentId
